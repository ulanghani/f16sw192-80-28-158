...
//        return inflater.inflate(R.layout.fragment_tab3, container, false);
        viewGroup = (ViewGroup) inflater.inflate(R.layout.fragment_tab3, container, false);
        mydatabase2 = new MyDatabase(this.getActivity());

//        adapterU.notifyDataSetChanged();

        listt = (ListView) viewGroup.findViewById(R.id.listt);
        System.out.println("---ufone fff = "+mydatabase2.getallUfone_data());


        adapterU = new Adapter_u(this.getActivity(), mydatabase2.getallUfone_data());
