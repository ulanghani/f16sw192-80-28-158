 ...
 * {@link Tab3_mobilink.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Tab3_mobilink#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Tab3_mobilink extends Fragment {
     ...
     * @return A new instance of fragment Tab3_mobilink.
     */
    // TODO: Rename and change types and number of parameters
    public static Tab3_mobilink newInstance(String param1, String param2) {
        Tab3_mobilink fragment = new Tab3_mobilink();
...
//        return inflater.inflate(R.layout.fragment_tab3_mobilink, container, false);

        viewGroup = (ViewGroup) inflater.inflate(R.layout.fragment_tab3_mobilink, container, false);
        mydatabase2 = new MyDatabase(this.getActivity());


        listt = (ListView) viewGroup.findViewById(R.id.listt);
        System.out.println("---ufone fff = "+mydatabase2.getallMobilink_data());
...
//                mydatabase2.getallRecordsStudent());
        ...
        adapterU = new Adapter_u(this.getActivity(), mydatabase2.getallMobilink_data());
