 ...
 * {@link Tab1_mobilink.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Tab1_mobilink#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Tab1_mobilink extends Fragment {
     ...
     * @return A new instance of fragment Tab1_mobilink.
     */
    // TODO: Rename and change types and number of parameters
    public static Tab1_mobilink newInstance(String param1, String param2) {
        Tab1_mobilink fragment = new Tab1_mobilink();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // return inflater.inflate(R.layout.fragment_tab1_mobilink, container, false);

        viewGroup = (ViewGroup) inflater.inflate(R.layout.fragment_tab1_mobilink, container, false);
        mydatabase2 = new MyDatabase(this.getActivity());


        listt = (ListView) viewGroup.findViewById(R.id.listt);
        System.out.println("---ufone fff = "+mydatabase2.getallMobilink_sms());
...
//                mydatabase2.getallRecordsStudent());
        ...
        adapterU = new Adapter_u(this.getActivity(), mydatabase2.getallMobilink_sms());
