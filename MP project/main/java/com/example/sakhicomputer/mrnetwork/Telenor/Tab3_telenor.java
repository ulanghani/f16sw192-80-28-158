 ...
 * {@link Tab3_telenor.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Tab3_telenor#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Tab3_telenor extends Fragment {
     ...
     * @return A new instance of fragment Tab3_telenor.
     */
    // TODO: Rename and change types and number of parameters
    public static Tab3_telenor newInstance(String param1, String param2) {
        Tab3_telenor fragment = new Tab3_telenor();
...
//        return inflater.inflate(R.layout.fragment_tab3_telenor, container, false);
        viewGroup = (ViewGroup) inflater.inflate(R.layout.fragment_tab3_telenor, container, false);
        mydatabase2 = new MyDatabase(this.getActivity());


        listt = (ListView) viewGroup.findViewById(R.id.listt);
        System.out.println("---ufone fff = "+mydatabase2.getallTelenor_data());
...
//                mydatabase2.getallRecordsStudent());
        ...
        adapterU = new Adapter_u(this.getActivity(), mydatabase2.getallTelenor_data());
