 ...
 * {@link Tab2_zong.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Tab2_zong#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Tab2_zong extends Fragment {
     ...
     * @return A new instance of fragment Tab2_zong.
     */
    // TODO: Rename and change types and number of parameters
    public static Tab2_zong newInstance(String param1, String param2) {
        Tab2_zong fragment = new Tab2_zong();
...
//        return inflater.inflate(R.layout.fragment_tab2_zong, container, false);

        viewGroup = (ViewGroup) inflater.inflate(R.layout.fragment_tab2_zong, container, false);
        mydatabase2 = new MyDatabase(this.getActivity());


        listt = (ListView) viewGroup.findViewById(R.id.listt);
        System.out.println("---ufone fff = "+mydatabase2.getallZong_call());
...
//                mydatabase2.getallRecordsStudent());
        ...
        adapterU = new Adapter_u(this.getActivity(), mydatabase2.getallZong_call());
