 ...
 * {@link Tab3_zong.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Tab3_zong#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Tab3_zong extends Fragment {
     ...
     * @return A new instance of fragment Tab3_zong.
     */
    // TODO: Rename and change types and number of parameters
    public static Tab3_zong newInstance(String param1, String param2) {
        Tab3_zong fragment = new Tab3_zong();
...
//        return inflater.inflate(R.layout.fragment_tab3_zong, container, false);

        viewGroup = (ViewGroup) inflater.inflate(R.layout.fragment_tab3_zong, container, false);
        mydatabase2 = new MyDatabase(this.getActivity());


        listt = (ListView) viewGroup.findViewById(R.id.listt);
        System.out.println("---ufone fff = "+mydatabase2.getallZong_data());
...
//                mydatabase2.getallRecordsStudent());
        ...
        adapterU = new Adapter_u(this.getActivity(), mydatabase2.getallZong_data());
