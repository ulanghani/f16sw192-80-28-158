...
public class Tab2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.fragment_tab2, container, false);
        mydatabase2 = new MyDatabase(this.getActivity());

//        adapterU.notifyDataSetChanged();

        listt = (ListView) viewGroup.findViewById(R.id.listt);
        System.out.println("---ufone fff = "+mydatabase2.getallUfone_call());


        adapterU = new Adapter_u(this.getActivity(), mydatabase2.getallUfone_call());
